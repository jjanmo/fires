...
const SignalHistoryChart = ({ rows, windowSize }: { rows: SignalRow[]; windowSize: number }) => {
  ...
  const counts = (['buy-1s', 'buy-2s', 'sell-1s', 'sell-2s'] as SignalType[]).map((k) => ({
    key: k,
